...
AUTH_TYPE=AUTH_LDAP
#AUTH_TYPE = AUTH_LDAP
#AUTH_LDAP_SERVER = "ldap://adldap.in.abc.com"
AUTH_LDAP_SERVER="ldaps://adldaps.in.abc.com:636"
...
AUTH_LDAP_USERNAME_FORMAT = "cn=%s,OU=FTE,OU=USERS,OU=ABC,OU=ABC,DC=in,DC=ABC,DC=com"  # %s is replaced with the provided username
